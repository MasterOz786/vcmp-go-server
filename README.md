...
| `store/script/main.nut` | **Client-side** Hydra camera (downloaded by players; no server SetCamera lag) |
...
Ensure `store/script/main.nut` exists (client Hydra camera). Players download it automatically from the server.
